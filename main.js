...
const {
    ...
    characters: [
        ...
        {name, animeJapaneseVoice: thirdCharacterJapaneseVoice}
    ]
} = roman
...
function hello({firstname, lastname, location}) {
    console.log(`Bonjour ${firstname} ${lastname}, t'es de ${location} !`);
}
...
function min(a, b, c, ...restOfParams) {
    return Math.min(a, b, c, ...restOfParams);
}
...
// const completeAddress = Object.assign({}, address, {postalCode: 75001});
const  completeAddress= {...address, postalCode: 75001};
...
//
// Migre ce code dans un module, importe le nécessaire pour l'utiliser

import exerciceSept from "./module/exerciceSept.js"


console.log("Exercice 7");

console.log("Ajout d'un Shampoing x2 à 10€");
exerciceSept.addToCart({product: "Shampoing", price: 10}, 2);

console.log("Mise à jour du panier : Shampoing x4");
exerciceSept.updateCartQuantity("Shampoing", 4);

console.log("Ajout d'un Biscuit x10 à 3€");
exerciceSept.addToCart({product: "Biscuit", price: 3}, 10);

console.log("Ajout d'un Biscuit x2 à 3€");
exerciceSept.addToCart({product: "Biscuit", price: 3}, 2);

console.log("Affichage du total panier :");
console.log(exerciceSept.displayAmount(exerciceSept.computeTotal()));
